...
|--------|------|----------|
| Accessibility | [`accessibility-defaults.md`](../rules/accessibility-defaults.md) | [`../standards/accessibility-testing.md`](accessibility-testing.md) |
| Privacy and data protection | [`privacy-defaults.md`](../rules/privacy-defaults.md) | [`../standards/privacy-engineering.md`](privacy-engineering.md) + [`../standards/privacy.md`](privacy.md) |
| Cookies and ePrivacy | [`cookie-discipline.md`](../rules/cookie-discipline.md) | [`../standards/cookies-eprivacy.md`](cookies-eprivacy.md) |
| Cybersecurity baseline | [`cybersecurity-baseline.md`](../rules/cybersecurity-baseline.md) | [`../standards/cybersecurity-baseline.md`](cybersecurity-baseline.md) + [`security.md`](../rules/security.md) |
| Consumer protection and e-commerce | [`consumer-defaults.md`](../rules/consumer-defaults.md) | [`../standards/consumer-protection.md`](consumer-protection.md) |
| Children's online privacy | [`children-privacy-defaults.md`](../rules/children-privacy-defaults.md) | [`../standards/children-privacy.md`](children-privacy.md) |
| AI compliance | [`ai-compliance-defaults.md`](../rules/ai-compliance-defaults.md) | [`../standards/ai-compliance.md`](ai-compliance.md) |
| Anti-spam and marketing | [`anti-spam-defaults.md`](../rules/anti-spam-defaults.md) | [`../standards/marketing-compliance.md`](marketing-compliance.md) |
| Sectoral (health, financial, biometric, identity, crypto, tax, whistleblower) | n/a (load standard on-demand by sector keyword) | [`../standards/sectoral-compliance.md`](sectoral-compliance.md) |
| Topical (DSA, FOIA/LAI, open data, election, content moderation, geolocation) | n/a (load standard on-demand by topical keyword) | [`../standards/topical-compliance.md`](topical-compliance.md) |
...
The remaining five domains load on keyword match. Triggers in [`index.yml`](../rules/index.yml).
...
- [`security.md`](../rules/security.md): cybersecurity baseline (web headers, CSP, encryption, supply chain)
- [`../standards/accessibility-testing.md`](accessibility-testing.md): accessibility testing infrastructure
