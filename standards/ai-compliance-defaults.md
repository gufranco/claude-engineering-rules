...
- [`../standards/ai-compliance.md`](ai-compliance.md): full implementation guide with risk-tier matrix, transparency notice template, automated decision UI patterns, deepfake disclosure UX
- [`../standards/mcp-security.md`](mcp-security.md): MCP server security + OWASP LLM Top 10 (2025) developer-side
- [`privacy-defaults.md`](../rules/privacy-defaults.md): GDPR Art. 22 + LGPD Art. 20 automated decision rights
- [`accessibility-defaults.md`](../rules/accessibility-defaults.md): `aria-live` for streaming model output
