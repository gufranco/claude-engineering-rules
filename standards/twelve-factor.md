...
See [`standards/database.md`](database.md) for connection management and [`rules/testing.md`](../rules/testing.md) for real service requirements.
...
See [`standards/infrastructure.md`](infrastructure.md) for CI/CD pipeline design and artifact management.
...
See [`standards/distributed-systems.md`](distributed-systems.md) for graceful shutdown and [`standards/resilience.md`](resilience.md) for idempotency patterns.
