...
Every frontend task that sells, subscribes, distributes goods or services, or solicits user contracts. Loaded by default per [`compliance-defaults.md`](../rules/compliance-defaults.md). Strictness target: EU Consumer Rights + Omnibus, with Brazil CDC overlay where the project serves Brazilian users.
...
- [`../standards/consumer-protection.md`](consumer-protection.md): full implementation guide with code patterns
- [`privacy-defaults.md`](../rules/privacy-defaults.md): personal data collected during purchase
- [`accessibility-defaults.md`](../rules/accessibility-defaults.md): checkout flow accessibility
