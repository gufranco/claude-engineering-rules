...
Container image authoring, BuildKit modern features, Compose security baseline, attestations, rootless mode, Hadolint, and the OWASP Docker Top 10 mapping live in [`standards/container-security.md`](container-security.md). That file is the single source of truth for Dockerfile and Compose security.
