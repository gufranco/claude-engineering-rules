...
- **Init process**: use `tini`, `dumb-init`, or `docker run --init` to handle PID 1 signal forwarding and zombie process reaping. See [`standards/twelve-factor.md`](twelve-factor.md) Factor IX for details
