...
- [`../standards/user-supplied-artifacts.md`](user-supplied-artifacts.md): manifest schema, canonicalization per platform, diagnosis table, patch distribution, self-service commands per operating system
- [`../standards/licensing.md`](licensing.md): license obligations for content the project does ship
- [`security.md`](../rules/security.md): supply chain and integrity verification for dependencies
- [`verification.md`](../rules/verification.md): evidence-based completion gates
- [`git-workflow.md`](../rules/git-workflow.md): ignored artifacts and what must never enter history
