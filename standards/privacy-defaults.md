...
Every frontend task that collects, stores, processes, or displays personal data. Loaded by default per [`compliance-defaults.md`](../rules/compliance-defaults.md). Strictness target: GDPR-grade by default everywhere, regardless of the project's stated jurisdiction.
...
- [`../standards/privacy-engineering.md`](privacy-engineering.md): full implementation guide
- [`../standards/privacy.md`](privacy.md): condensed reference
- [`security.md`](../rules/security.md): security baseline (encryption, audit logs)
- [`cookie-discipline.md`](../rules/cookie-discipline.md): cookies and ePrivacy specifics
- [`children-privacy-defaults.md`](../rules/children-privacy-defaults.md): children's data
