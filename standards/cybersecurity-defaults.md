...
Every frontend task. Loaded by default per [`compliance-defaults.md`](../rules/compliance-defaults.md). Composes with [`security.md`](../rules/security.md) which covers cross-cutting security (secrets, encryption, supply chain, auth). This rule covers the frontend-specific cybersecurity defaults.
...
| Headers | HSTS, CSP, X-Content-Type-Options, X-Frame-Options, Referrer-Policy, Permissions-Policy; full table in [`security.md`](../rules/security.md) |
...
- [`security.md`](../rules/security.md): cross-cutting security baseline
- [`compliance-defaults.md`](../rules/compliance-defaults.md): umbrella rule
- [`../standards/cybersecurity-baseline.md`](cybersecurity-baseline.md): breach notification UI templates, NIS2 + DORA scope
- [`../standards/secrets-management.md`](secrets-management.md): secrets handling
- [`privacy-defaults.md`](../rules/privacy-defaults.md): privacy obligations overlap
