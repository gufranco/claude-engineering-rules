...
A short daily checklist of engineering principles distilled from [`../standards/engineering-discipline.md`](engineering-discipline.md). The standards file is the deep reference; this rule is the everyday version.

Loaded on demand for code-change tasks. Triggers in [`index.yml`](../rules/index.yml).
...
- [`../standards/engineering-discipline.md`](engineering-discipline.md). The deep reference this file checklists.
- [`design-philosophy.md`](../rules/design-philosophy.md). The vocabulary (module, interface, seam, adapter) that the checklist uses.
- [`code-style.md`](../rules/code-style.md). The mechanical rules that encode several items directly.
- [`smart-questions.md`](../rules/smart-questions.md). The communication discipline used in the last section.
- [`verification.md`](../rules/verification.md). The evidence-based completion gates.
