...
Every frontend task that sets cookies, uses localStorage, sessionStorage, IndexedDB, or any other client-side storage. Loaded by default per [`compliance-defaults.md`](../rules/compliance-defaults.md). Strictness target: ePrivacy + GDPR opt-in by default everywhere.
...
- [`../standards/cookies-eprivacy.md`](cookies-eprivacy.md): full banner UX patterns and category definitions
- [`accessibility-defaults.md`](../rules/accessibility-defaults.md): banner accessibility
