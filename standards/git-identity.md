...
| Defensive | [`hooks/git-author-guard.py`](hooks/git-author-guard.py) | Blocks commits, pushes, and config mutations that would use the wrong identity |
...
[`hooks/git-author-guard.py`](hooks/git-author-guard.py) runs on PreToolUse for Bash commands. It splits triggers into three categories.
...
- [`standards/multi-account-cli.md`](standards/multi-account-cli.md): umbrella standard for the multi-account isolation pattern.
- [`standards/github-accounts.md`](standards/github-accounts.md): per-command rules for `gh`.
- [`standards/gitlab-accounts.md`](standards/gitlab-accounts.md): per-command rules for `glab`.
