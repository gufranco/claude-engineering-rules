...
Every frontend task. The rule is loaded by default per [`compliance-defaults.md`](../rules/compliance-defaults.md). Full conformance target: WCAG 2.2 Level AA mandatory + Level AAA where it does not conflict with AA.
...
| Accessibility statement | Required on every project; template in [`../standards/accessibility-testing.md`](accessibility-testing.md) |
...
- [`compliance-defaults.md`](../rules/compliance-defaults.md): umbrella rule, locked targets
- [`../standards/accessibility-testing.md`](accessibility-testing.md): full implementation guide
- [`../standards/frontend.md`](frontend.md): frontend patterns with cross-links
