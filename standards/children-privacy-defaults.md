...
Loaded on-demand when a frontend task targets, attracts, or may be accessed by users under 18. Triggered by keywords: child, children, kid, minor, under-18, under-16, under-13, COPPA, AADC, parental consent, age gate, educational content, gaming, family. Per [`compliance-defaults.md`](../rules/compliance-defaults.md).
...
- [`privacy-defaults.md`](../rules/privacy-defaults.md): privacy obligations
- [`../standards/children-privacy.md`](children-privacy.md): full implementation guide including age gate UI patterns, COPPA verifiable parental consent flow, UK Code 15 standards detail
- [`accessibility-defaults.md`](../rules/accessibility-defaults.md): age-appropriate UI accessibility
