...
Use two references:
1. `../../checklists/checklist.md` for all 69 quality categories.
...
- Apply all 69 checklist categories, not just 1-52. Categories 53-58 cover LLM trust boundary, performance budget, zero-downtime deployment, supply chain security, event-driven architecture, and licensing compliance.
