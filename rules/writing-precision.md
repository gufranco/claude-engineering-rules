...
For question messages, status updates, error reports, subagent prompts, and loop-closure lines, apply [`rules/smart-questions.md`](rules/smart-questions.md) in addition to this gate.
