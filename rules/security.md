...
| Git author identity (commit/push/config under wrong, missing, or placeholder identity) | Block | git-author-guard | 4 |
| AI attribution lines (Co-authored-by Claude/AI/Anthropic, Generated by AI) | Block | ai-attribution-blocker | 6 |
